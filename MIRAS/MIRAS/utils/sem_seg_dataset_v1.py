...
#v0是原版/v1是在单目标+{object_name}/gres是多目标/空目标+{object_name}
...
class SemSegDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        answers = []
        class_ids = []
        assert isinstance(sampled_classes, list)
        ...
        for sampled_cls in sampled_classes:
            ...
            #     answers.append(random.choice(self.answer_list))
            # elif random_num==1:
            answers_template = random.choice(self.answer_list_obj)
