...
from mgm.model.mgmmask_arch import MGMMetaModel, MGMMetaForCausalLM
...
class CausalLMOutputWithPastAndFeature(CausalLMOutputWithPast):
    ...
    def __init__(self, loss=None, logits=None, past_key_values=None, hidden_states=None, attentions=None, image_features=None):
        ...
        **kwargs,
        ...
        if attention_mask is None:
            return super().generate(inputs_embeds=inputs_embeds
                                    ...
                                    return_dict_in_generate=True), image_features
        ...
        #     print("Detailed traceback info:")
        #     traceback.print_exc()


    def prepare_inputs_for_generation(self, input_ids, past_key_values=None, inputs_embeds=None,clip_resize_list=None,**kwargs):
        images = kwargs.pop("images", None)
        images_aux = kwargs.pop("images_aux", None)
        _inputs = super().prepare_inputs_for_generation(
            input_ids, past_key_values=past_key_values, inputs_embeds=inputs_embeds,clip_resize_list=clip_resize_list, **kwargs
        )
        if images is not None:
...
AutoConfig.register("mgm_mask", MGMConfig)
