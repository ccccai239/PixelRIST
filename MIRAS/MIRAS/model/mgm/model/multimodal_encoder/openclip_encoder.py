...
class OpenCLIPVisionTower(nn.Module):
    ...
    def load_model(self):
        ...
        #print('convnext' in self.vision_tower_name,'large' in self.vision_tower_name,)
    ...
    def forward(self, images):
        ...
        return image_features # (bs, 2880, 84, 84)
    ...
    def backbone(self, images):
        ...
        target_size = (48,48)    # (results['stage_0'].shape[-2], results['stage_0'].shape[-1])
        result_cat = []
        ...
        result_cat = torch.cat(result_cat, dim=1)  #（bs,2880,84,84)
